        ...
        <div class="cf-flex-col cf-justify-start cf-items-end pos_3">
          <div class="cf-flex-col section_3">
            ...
            <div class="cf-flex-col group_3">
              <div class="space-x-10 cf-flex-row cf-items-end group_4">
                <span class="font_3 text_4">Don't have an account?</span>
                <router-link :to="{ name: 'register' }"
                  ><span class="font_2 signup">Sign up for free</span></router-link
                >
              </div>
            </div>
            <div class="cf-flex-col group_5 space-y-42">
              ...
              >
                ...
                />
                <a :href="googleAuth"><span class="font_4">Continue with Goolge</span></a>
              ...
              <div class="cf-flex-col">
                <div class="cf-flex-col space-y-11">
                  ...
                  <input class="text-wrapper_3" type="text" placeholder="email" v-model="email" />
                </div>
                ...
                <router-link to="/forgetPassword" class="cf-self-center font_3 text_8"
  ...
  methods: {
    ...
    async getUserInfo(ui) {
      try {
        ...
        const response = await this.$axios.post("/api/GetWebUserInfo/interface", formData);
        console.log({ response });
      } catch (e) {
        console.log({ e });
      }
